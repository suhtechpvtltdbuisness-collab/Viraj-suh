...
export const metadata: Metadata = {
  ...
  keywords:
    "cash for gold noida, gold buyers noida, sell gold noida, diamond buyers noida, silver buyers noida, cash for diamond noida, gold buyer near me noida, best gold rates noida",
  openGraph: {
    title: "Cash for Gold in Noida | Silver & Diamond Buyers | Viraj Jewellers",
    description:
      "Trusted Cash for Gold, Silver & Diamond buyers in Noida with instant payment & highest rates",
  ...
  const services = [
    {
      ...
      description:
        "Sell gold jewelry, coins, or ornaments at the highest market price with complete transparency using advanced XRF purity testing.",
      icon: Award,
    ...
    },
    {
      ...
      description:
        "Instant cash for silver articles, utensils, coins, and jewelry at fair market valuation with no hidden charges.",
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Premium cash for certified diamonds and diamond jewelry with expert gemologist evaluation and instant payment.",
      icon: TrendingUp,
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-yellow-50 to-amber-50 py-16">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <p className="text-xl text-gray-700 mb-6 max-w-3xl">
            Viraj Jewellers offers trusted and transparent cash for gold,
            silver, and diamond services across all Noida sectors with instant
            payment and the highest market rates guaranteed.
          </p>
      ...
      <section id="cash-for-gold-noida" className="py-16 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="prose max-w-none text-gray-700 space-y-4">
            <p className="text-lg">
              <strong>Viraj Jewellers</strong> is a trusted and well-recognized
              name for <strong>Cash for Gold in Noida</strong>, offering
              customers a secure, transparent, and highly profitable way to sell
              gold. We understand that selling gold is often an important
              financial decision, which is why we focus on honesty, clarity, and
              customer comfort at every step.
            </p>
            <p>
              Whether you want to sell old gold jewelry, broken ornaments, gold
              coins, biscuits, or inherited gold assets, we ensure a smooth and
              worry-free experience. Our evaluation process is powered by
              advanced <strong>XRF purity testing technology</strong>, which
              allows us to test gold accurately in your presence without melting
              or damaging it.
            </p>
            <div className="bg-yellow-50 border-l-4 border-yellow-600 p-6 my-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">
                Why Choose Us for Cash for Gold in Noida
              </h3>
            ...
            <p>
              Once the valuation is finalized, payments are made instantly
              through cash, UPI, or direct bank transfer, as per your
              convenience. All transactions are conducted under strict KYC norms
              with proper documentation, ensuring legal compliance and customer
              safety.
            </p>
          </div>
        </div>
      ...
      <section id="cash-for-silver-noida" className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="prose max-w-none text-gray-700 space-y-4">
              <p>
                Viraj Jewellers offers professional and transparent{" "}
                <strong>Cash for Silver in Noida</strong>, helping customers
                convert their silver assets into instant cash at the best
                possible market rates.
              </p>
              <p>We buy all types of silver items including:</p>
              ...
              <p>
                Our silver valuation process involves accurate weight
                measurement, purity testing, and pricing aligned with real-time
                silver market rates. We clearly explain the valuation process to
                customers, ensuring complete transparency and confidence.
              </p>
            </div>
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                Silver Selling Process
              </h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      Visit our store or request doorstep service
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      Accurate weight and purity assessment
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm">
                      Receive cash, UPI, or bank transfer immediately
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="diamond-buyers-noida" className="py-16 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="prose max-w-none text-gray-700 space-y-4">
            <p className="text-lg">
              <strong>Viraj Jewellers</strong> is a trusted and professional{" "}
              <strong>Diamond Buyer in Noida</strong>, offering customers a
              secure, transparent, and rewarding way to sell diamond jewelry at
            ...
            <div className="grid md:grid-cols-2 gap-8 my-8">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 mb-4">
                  Our diamond evaluation is conducted by experienced gemologists
                  using internationally accepted grading standards:
                </p>
                <ul className="space-y-2 text-gray-700">
                  <li>
                    <strong>Cut:</strong> Quality and symmetry of diamond cut
                  </li>
                  <li>
                    <strong>Clarity:</strong> Internal and external
                    characteristics
                  </li>
                  <li>
                    <strong>Color:</strong> Diamond color grading scale
                  </li>
                  <li>
                    <strong>Carat:</strong> Precise weight measurement
                  </li>
                </ul>
              </div>
            </div>
            <p>
              We ensure complete transparency by clearly explaining how the
              diamond's value is calculated based on the 4Cs and current market
              demand. All offers are aligned with real-time diamond market
              trends, with no hidden charges or deductions.
            </p>
            <p>
              Once the valuation is approved, customers receive instant payment
              through cash, UPI, or secure bank transfer. All transactions
              follow strict KYC compliance with proper documentation for
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
            Service Coverage Across Noida
          </h2>
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-8">
            <p className="text-gray-700 text-center mb-6">
              We provide doorstep and in-store services across all major sectors
              and localities in Noida:
            </p>
      ...
      <section className="py-16 bg-gradient-to-r from-yellow-600 to-amber-600">
        <div className="mx-auto max-w-4xl px-4 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Sell Your Gold, Silver, or Diamond in Noida?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Get instant cash with transparent valuation and the highest market
            rates
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    SHOP: O-14, LAJPAT NAGAR - II
                    <br />
                    NEAR GOLDEN DRAGON RESTAURANT
                    <br />
                    NEW DELHI - 110024
                  </p>
                </div>
      ...
      <section className="py-12 bg-white border-t">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Link
              href="/locations/lajpat-nagar"
              className="text-yellow-600 hover:text-yellow-700 hover:underline"
            >
              Cash for Gold Lajpat Nagar
            </Link>
            <Link
              href="/services/diamond-buyers"
              className="text-yellow-600 hover:text-yellow-700 hover:underline"
            >
